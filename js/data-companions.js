...
const COMPANION_CLASS_PROFILES = {
  101: { classId:101, className:'보병', unitType:'Infantry', roleKey:'tank', roleLabel:'전방 탱커', attackRange:50, preferredRange:34, attackCooldown:980, skillId:'slime_guard', skillName:'점액 방패', skillCooldown:5200, aiDefault:'defensive', basicAttack: { kind:'arc-shock', shockRadius:58, shockDelayMs:90, shockDamageRatio:0.35, shockKnockbackMult:1.4, shockColor:'#ecf0f1', shockGlow:'#ffffff' }, allowedSkillCategories:['physical', 'support_magic'], defaultSkillLineup:[['slash', 'shield', 'iron_fortress', 'sprint'], ['whirlwind', 'drain', 'heal', null], [null, null, null, null]] },
  102: { classId:102, className:'비병', unitType:'FlyingKnight', roleKey:'assassin', roleLabel:'고기동 추격', attackRange:60, preferredRange:42, attackCooldown:820, skillId:'shadow_strike', skillName:'암영 참격', skillCooldown:5000, aiDefault:'aggressive', basicAttack: { kind:'arc-combo', hits:2, hitDelayMs:130, damagePerHit:0.62, comboColor:'#6c5ce7', comboGlow:'#a29bfe' }, allowedSkillCategories:['physical', 'support_magic'], defaultSkillLineup:[['slash', 'sprint', 'drain', 'heal'], ['whirlwind', 'shield', null, null], [null, null, null, null]] },
  103: { classId:103, className:'기병', unitType:'Cavalry', roleKey:'paladin', roleLabel:'돌격 딜러', attackRange:64, preferredRange:48, attackCooldown:980, skillId:'dark_aegis', skillName:'암흑 수호', skillCooldown:6200, aiDefault:'defensive', basicAttack: { kind:'lance-charge', lineLength:100, lineWidth:32, damageMult:0.9, chargeColor:'#dfe6e9', chargeGlow:'#b2bec3' }, allowedSkillCategories:['physical', 'support_magic'], defaultSkillLineup:[['slash', 'iron_fortress', 'shield', 'sprint'], ['whirlwind', 'drain', 'heal', null], [null, null, null, null]] },
  104: { classId:104, className:'수병', unitType:'NavalUnit', roleKey:'guardian', roleLabel:'빙결 제어', attackRange:62, preferredRange:46, attackCooldown:1040, skillId:'frost_lock', skillName:'빙결 봉쇄', skillCooldown:5400, aiDefault:'defensive', basicAttack: { kind:'arc-chill', chillDurationMs:1600, chillSpeedMult:0.55, chillColor:'#74b9ff', chillGlow:'#dff9fb' }, allowedSkillCategories:['physical', 'support_magic'], defaultSkillLineup:[['slash', 'shield', 'iron_fortress', 'heal'], ['drain', 'sprint', null, null], [null, null, null, null]] },
  105: { classId:105, className:'창병', unitType:'Lancer', roleKey:'bruiser', roleLabel:'중거리 물리', attackRange:56, preferredRange:40, attackCooldown:960, skillId:'war_cleave', skillName:'전투 강타', skillCooldown:4300, aiDefault:'aggressive', basicAttack: { kind:'arc-thrust', rangeBonus:30, arcWidthOverride:0.22 * Math.PI, mainTargetDamageMult:1.3, thrustColor:'#c0392b', thrustGlow:'#e74c3c' }, allowedSkillCategories:['physical', 'support_magic'], defaultSkillLineup:[['slash', 'whirlwind', 'sprint', 'heal'], ['drain', 'shield', null, null], [null, null, null, null]] },
  106: { classId:106, className:'궁병', unitType:'Archer', roleKey:'ranger', roleLabel:'원거리 딜러', attackRange:128, preferredRange:92, attackCooldown:1080, skillId:'arrow_barrage', skillName:'연발 사격', skillCooldown:4800, aiDefault:'aggressive', basicAttack: { kind:'projectile', shape:'arrow', speed:5.6, range:220, size:7, color:'#f5c85f', glow:'#fff4bf', damageType:'normal', pierce:0, hitRadius:14 }, allowedSkillCategories:['physical', 'support_magic'], defaultSkillLineup:[['slash', 'sprint', 'heal', 'shield'], ['whirlwind', 'drain', null, null], [null, null, null, null]] },
  107: { classId:107, className:'승려', unitType:'Monk', roleKey:'support', roleLabel:'전투 서포트', attackRange:104, preferredRange:80, attackCooldown:1180, skillId:'holy_prayer', skillName:'백광 기도', skillCooldown:5800, aiDefault:'support', basicAttack: { kind:'arc-aura', auraRadius:78, auraDamageRatio:0.55, auraDelayMs:110, color:'#f1c40f', glow:'#fff4bf' }, allowedSkillCategories:['support_magic', 'physical'], defaultSkillLineup:[['heal', 'shield', 'sprint', 'iron_fortress'], ['slash', 'drain', null, null], [null, null, null, null]] },
  108: { classId:108, className:'신관', unitType:'Priest', roleKey:'support', roleLabel:'힐러/버퍼', attackRange:96, preferredRange:84, attackCooldown:1300, skillId:'holy_prayer', skillName:'성역 기도', skillCooldown:5400, aiDefault:'support', basicAttack: { kind:'projectile', shape:'shard', speed:3.6, range:200, size:11, color:'#74b9ff', glow:'#dff9fb', damageType:'magic', pierce:2, hitRadius:16 }, allowedSkillCategories:['support_magic', 'attack_magic'], defaultSkillLineup:[['heal', 'shield', 'sprint', 'iron_fortress'], ['thunder', null, null, null], [null, null, null, null]] },
  109: { classId:109, className:'법사', unitType:'Mage', roleKey:'caster', roleLabel:'광역 마법', attackRange:118, preferredRange:86, attackCooldown:1200, skillId:'bone_nova', skillName:'망령 폭발', skillCooldown:5600, aiDefault:'aggressive', basicAttack: { kind:'projectile', shape:'orb', speed:4.2, range:200, size:12, color:'#e74c3c', glow:'#ff8a65', damageType:'magic', pierce:0, hitRadius:18 }, allowedSkillCategories:['attack_magic'], defaultSkillLineup:[['fireball', 'thunder', 'meteor', 'poison'], ['life_drain', null, null, null], [null, null, null, null]] },
  110: { classId:110, className:'사교', unitType:'DarkPriest', roleKey:'mage', roleLabel:'약화 마도', attackRange:132, preferredRange:94, attackCooldown:1220, skillId:'flame_burst', skillName:'화염 난사', skillCooldown:5200, aiDefault:'aggressive', basicAttack: { kind:'projectile', shape:'orb', speed:4.6, range:210, size:12, color:'#8e44ad', glow:'#d6b3ff', damageType:'magic', pierce:0, hitRadius:18 }, allowedSkillCategories:['attack_magic', 'support_magic'], defaultSkillLineup:[['fireball', 'thunder', 'poison', 'life_drain'], ['shield', 'iron_fortress', null, null], ['meteor', null, null, null]] },
};
...
function getClassSkillPolicy(classId) {
  const p = COMPANION_CLASS_PROFILES[classId];
  if (!p) return null;
  return { allowed: p.allowedSkillCategories || null, defaultLineup: p.defaultSkillLineup || null };
}
function isSkillAllowedForClass(skillId, classId) {
  const skill = typeof getSkillById === 'function' ? getSkillById(skillId) : null;
  if (!skill || !skill.category) return true; // permissive fallback
  const policy = getClassSkillPolicy(classId);
  if (!policy || !Array.isArray(policy.allowed)) return true;
  return policy.allowed.includes(skill.category);
}
